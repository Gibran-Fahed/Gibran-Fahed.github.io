...
const Navbar = () => {
    ...
    return (
        <nav className={`${styles.paddingX} py-4 w-full flex fixed top-0 z-20 items-center bg-primary`}>
            <div className="flex items-center justify-between flex-1 w-full max-w-7xl mx-auto">
                ...
                <div className="flex flex-1 justify-end items-center sm:hidden">
                    <img src={!toggle ? menu : close} alt="" className="w-[28px] h-[28px] object-contain cursor-pointer"
                         onClick={() => setToggle(!toggle)}/>
                    <div
                        className={`${toggle ? 'flex' : 'hidden'} black-gradient rounded-xl absolute right-0 top-20 my-2 mx-4 p-6 z-10 min-w-[140px]`}>
